        ...
        )
{
    ...
    {
        // Copy the strings
        int cbSize = countof(m_wchFile) - 1;
        wcsncpy(m_wchFile, pwsFile, cbSize);
        m_wchFile[cbSize] = 0;
        cbSize = countof(m_wchFileTitle) - 1;
        wcsncpy(m_wchFileTitle, pwsFileTitle, cbSize);
        m_wchFileTitle[cbSize] = 0;
