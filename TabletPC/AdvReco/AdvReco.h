...
public:
    ...
    CComPtr<IInkWordList>           m_spIInkWordList;
    ...
    CAdvRecoApp() :
        ...
        m_nCmdGuide(0), m_nCmdFactoid(0), m_nCmdRecognizer(0), m_nCmdMode(0),
...
BEGIN_MSG_MAP(CAdvRecoApp)
    ...
    COMMAND_ID_HANDLER(ID_FACTOID_WORDLIST, OnFactoidWordlist)
    COMMAND_RANGE_HANDLER(ID_FACTOID_FIRST, ID_FACTOID_LAST, OnFactoid)
...
public:
    ...
    LRESULT OnFactoidWordlist(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled);
    LRESULT OnFactoid(WORD wNotifyCode, WORD wID, HWND hWndCtl, BOOL& bHandled);
