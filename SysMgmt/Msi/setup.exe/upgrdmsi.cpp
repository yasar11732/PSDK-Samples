...
bool IsUpdateRequiredVersion(LPSTR szFilename, ULONG ulMinVer)
{
...
UINT ValidateUpdate(HINSTANCE hInst, CDownloadUI *piDownloadUI, LPCSTR szAppTitle, LPSTR szUpdatePath, LPCSTR szModuleFile, ULONG ulMinVer)
{
