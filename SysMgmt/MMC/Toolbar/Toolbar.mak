...
!MESSAGE No configuration specified. Defaulting to Toolbar - Win32 Ansi Debug.
!ENDIF 

!IF "$(CFG)" != "Toolbar - Win32 Release" && "$(CFG)" != "Toolbar - Win32 Debug" && "$(CFG)" != "Toolbar - Win32 Ansi Release" && "$(CFG)" != "Toolbar - Win32 Ansi Debug"
...
ALL : "$(OUTDIR)\Toolbar.dll" ".\Release\regsvr32.trg"
...
CLEAN :
	...
	-@erase "$(OUTDIR)\Toolbar.dll"
	-@erase "$(OUTDIR)\Toolbar.exp"
	-@erase "$(OUTDIR)\Toolbar.lib"
...
CPP=cl.exe
CPP_PROJ=/nologo /MT /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "Toolbar_EXPORTS" /D "UNICODE" /D "_UNICODE" /Fp"$(INTDIR)\Toolbar.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib mmc.lib /nologo /base:"0x16000000" /dll /incremental:no /pdb:"$(OUTDIR)\Toolbar.pdb" /machine:I386 /def:".\BaseSnap.Def" /out:"$(OUTDIR)\Toolbar.dll" /implib:"$(OUTDIR)\Toolbar.lib" 
DEF_FILE= \
	".\BaseSnap.Def"
LINK32_OBJS= \
	"$(INTDIR)\About.obj" \
...
"$(OUTDIR)\Toolbar.dll" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
ALL : "$(OUTDIR)\Toolbar.dll" "$(OUTDIR)\Toolbar.bsc" ".\Debug\regsvr32.trg"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib mmc.lib /nologo /base:"0x16000000" /dll /incremental:yes /pdb:"$(OUTDIR)\Toolbar.pdb" /debug /machine:I386 /def:".\BaseSnap.Def" /out:"$(OUTDIR)\Toolbar.dll" /implib:"$(OUTDIR)\Toolbar.lib" /pdbtype:sept 
DEF_FILE= \
	".\BaseSnap.Def"
LINK32_OBJS= \
	"$(INTDIR)\About.obj" \
...
ALL : "$(OUTDIR)\Toolbar.dll" ".\Ansi_release\regsvr32.trg"
...
CPP=cl.exe
CPP_PROJ=/nologo /MT /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "Toolbar_EXPORTS" /Fp"$(INTDIR)\Toolbar.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
ALL : "$(OUTDIR)\Toolbar.dll" "$(OUTDIR)\Toolbar.bsc" ".\Ansi_debug\regsvr32.trg"
