...
!IF "$(CFG)" != "MultiSel - Win32 Release" && "$(CFG)" != "MultiSel - Win32 Debug" && "$(CFG)" != "MultiSel - Win32 Ansi Release" && "$(CFG)" != "MultiSel - Win32 Ansi Debug"
...
CPP=cl.exe
CPP_PROJ=/nologo /MT /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "MultiSel_EXPORTS" /D "UNICODE" /D "_UNICODE" /Fp"$(INTDIR)\multisel.pch" /YX /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib mmc.lib /nologo /base:"0x11000000" /dll /incremental:no /pdb:"$(OUTDIR)\multisel.pdb" /machine:I386 /def:".\BaseSnap.Def" /out:"$(OUTDIR)\multisel.dll" /implib:"$(OUTDIR)\multisel.lib" 
DEF_FILE= \
	".\BaseSnap.Def"
LINK32_OBJS= \
	"$(INTDIR)\About.obj" \
...
ALL : "$(OUTDIR)\multisel.dll" "$(OUTDIR)\multisel.bsc" ".\Debug\regsvr32.trg"
...
"$(OUTDIR)\multisel.bsc" : "$(OUTDIR)" $(BSC32_SBRS)
    $(BSC32) @<<
  $(BSC32_FLAGS) $(BSC32_SBRS)
<<

LINK32=link.exe
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib mmc.lib /nologo /base:"0x11000000" /dll /incremental:yes /pdb:"$(OUTDIR)\multisel.pdb" /debug /machine:I386 /def:".\BaseSnap.Def" /out:"$(OUTDIR)\multisel.dll" /implib:"$(OUTDIR)\multisel.lib" /pdbtype:sept 
DEF_FILE= \
	".\BaseSnap.Def"
LINK32_OBJS= \
	"$(INTDIR)\About.obj" \
...
ALL : "$(OUTDIR)\multisel.dll" "$(OUTDIR)\multisel.bsc" ".\Ansi_debug\regsvr32.trg"
