...
// WizExt.h : Declaration of the CWizExtUser
...
// CWizExtUser
//
// This class implements the interface needed for a secondary wizard extension
// for DS Admin.
//
////////////////////////////////////////////////////////////////////////////////

class /*ATL_NO_VTABLE*/ CWizExtUser : 
	public CComObjectRootEx<CComSingleThreadModel>,
	public IDsAdminNewObjExt,
  public CComCoClass<CWizExtUser, &CLSID_WizExtUser>
{
public:
	CWizExtUser()
	{
    m_hObjClassIcon = NULL;
 	...
 	~CWizExtUser()
	{
    if (m_pExtPageUser != NULL)
      delete m_pExtPageUser;
	}


BEGIN_COM_MAP(CWizExtUser)
...
protected:
  ...
  //
  // The class that handles the user interface for the extension
  //
  CExtPageUser* m_pExtPageUser;
};
