...
'==============================================================
'Note:
'This sample requires a reference to AdsSecurity.dll in order
'to compile and run.  AdsSecurity.dll is installed with the PSDK as
'part of the ADSI Resource Kit.  The AdsSecurity Type Library
'should be loaded as a reference for this sample when you open
'the Visual Basic project file.  If it is not, select References
'from the Project menu in Visual Basic, and use the browse button
'to select AdsSecurity.dll.
'==============================================================
