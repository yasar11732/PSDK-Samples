...
LINK32=link.exe
LINK32_FLAGS=..\..\..\..\lib\mqrt.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\mqf_draw.pdb" /machine:$(CPU) /out:"$(OUTDIR)\mqf_draw.exe" 
LINK32_OBJS= \
...
LINK32=link.exe
LINK32_FLAGS=..\..\..\..\mqrt.lib /nologo /subsystem:windows /incremental:no /pdb:"$(OUTDIR)\mqf_draw.pdb" /debug /machine:$(CPU) /out:"$(OUTDIR)\mqf_draw.exe" /pdbtype:sept 
LINK32_OBJS= \
	"$(INTDIR)\connectdlg.obj" \
	"$(INTDIR)\drawarea.obj" \
	"$(INTDIR)\drawdlg.obj" \
