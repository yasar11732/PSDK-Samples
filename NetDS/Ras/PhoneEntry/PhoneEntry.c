        ...
        case WM_INITDIALOG:
            ...
            {                   // Display parametres of the existing entry
                if (g_lpRasEntry->dwfOptions & RASEO_SpecificIpAddr)
                {
                    ...
                    _snprintf(buff, CELEMS(buff), "%d.%d.%d.%d", g_lpRasEntry->ipaddr.a, g_lpRasEntry->ipaddr.b,
                ...
                if (g_lpRasEntry->dwfOptions & RASEO_SpecificNameServers)
                {
                    ...
                    _snprintf(buff, CELEMS(buff), "%d.%d.%d.%d", g_lpRasEntry->ipaddrDns.a, g_lpRasEntry->ipaddrDns.b,
                        g_lpRasEntry->ipaddrDns.c, g_lpRasEntry->ipaddrDns.d);
                    SendMessage(hEdit2, WM_SETTEXT, 0, (LPARAM) (LPCTSTR) buff);
                    
                    _snprintf(buff, CELEMS(buff), "%d.%d.%d.%d", g_lpRasEntry->ipaddrDnsAlt.a, g_lpRasEntry->ipaddrDnsAlt.b,
                        g_lpRasEntry->ipaddrDnsAlt.c, g_lpRasEntry->ipaddrDnsAlt.d);
                    SendMessage(hEdit3, WM_SETTEXT, 0, (LPARAM) (LPCTSTR) buff);
                    
                    _snprintf(buff, CELEMS(buff), "%d.%d.%d.%d", g_lpRasEntry->ipaddrWins.a, g_lpRasEntry->ipaddrWins.b,
                        g_lpRasEntry->ipaddrWins.c, g_lpRasEntry->ipaddrWins.d);
                    SendMessage(hEdit4, WM_SETTEXT, 0, (LPARAM) (LPCTSTR) buff);
                    
                    _snprintf(buff, CELEMS(buff), "%d.%d.%d.%d", g_lpRasEntry->ipaddrWinsAlt.a, g_lpRasEntry->ipaddrWinsAlt.b,
            ...
            switch (LOWORD(wParam))
            {
                case IDOK:
                    ...
                    {           
                        ...
                        g_lpRasEntry->ipaddr.a = a;
                        g_lpRasEntry->ipaddr.b = b;
                        g_lpRasEntry->ipaddr.c = c;
                        g_lpRasEntry->ipaddr.d = d;
                    }
                    ...
                    {           
                        ...
                        sscanf(buff, "%d.%d.%d.%d", &a, &b, &c, &d);
                        g_lpRasEntry->ipaddrDns.a = a;
                        g_lpRasEntry->ipaddrDns.b = b;
                        g_lpRasEntry->ipaddrDns.c = c;
                        g_lpRasEntry->ipaddrDns.d = d;
                        
                        GetWindowText(GetDlgItem(hWnd, IDC_EDIT3), buff, CELEMS(buff));
                        sscanf(buff, "%d.%d.%d.%d", &a, &b, &c, &d);
                        g_lpRasEntry->ipaddrDnsAlt.a = a;
                        g_lpRasEntry->ipaddrDnsAlt.b = b;
                        g_lpRasEntry->ipaddrDnsAlt.c = c;
                        g_lpRasEntry->ipaddrDnsAlt.d = d;

                        GetWindowText(GetDlgItem(hWnd, IDC_EDIT6), buff, CELEMS(buff));
                        sscanf(buff, "%d.%d.%d.%d", &a, &b, &c, &d);
                        g_lpRasEntry->ipaddrWins.a = a;
                        g_lpRasEntry->ipaddrWins.b = b;
                        g_lpRasEntry->ipaddrWins.c = c;
                        g_lpRasEntry->ipaddrWins.d = d;
                        
                        GetWindowText(GetDlgItem(hWnd, IDC_EDIT7), buff, CELEMS(buff));
                        sscanf(buff, "%d.%d.%d.%d", &a, &b, &c, &d);
                        g_lpRasEntry->ipaddrWinsAlt.a = a;
                        g_lpRasEntry->ipaddrWinsAlt.b = b;
                        g_lpRasEntry->ipaddrWinsAlt.c = c;
                        g_lpRasEntry->ipaddrWinsAlt.d = d;
                    }
                    else        
                    {
...
INT_PTR CALLBACK Page0Proc(HWND hWnd, UINT uMsgID, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (uMsgID)
    {
        case WM_INITDIALOG:
            ...
            {
                _snprintf(szTemp, CELEMS(szTemp), "HeapAlloc failed.");
                return 0;
            }
            ...
            default:
                _snprintf(szTemp, CELEMS(szTemp), "RasEnumDevices failed: %d ", nRet);
            ...
            else
            {
                ...
                if (!cDevices)
                {
                    _snprintf(szTemp, CELEMS(szTemp), "No RAS capable devices found.");
                    MessageBox(hWnd, szTemp, NULL, MB_OK | MB_ICONERROR);
                    return 0;
                }
                else
            ...
            while (lpRasCtryInfo->dwCountryID)
            {
                ...
                if (nRet)
                {
                    _snprintf(szTemp, CELEMS(szTemp), "RasGetCountryInfo failed: %d", nRet);
                    MessageBox(hWnd, szTemp, NULL, MB_OK | MB_ICONERROR);
                    return FALSE;
                }
                
                _snprintf(szCCode, CELEMS(szCCode), "%s (%d)", (LPSTR) lpRasCtryInfo + lpRasCtryInfo->dwCountryNameOffset, lpRasCtryInfo->dwCountryCode);
                ...
                {
                    lstrcpyn(szTemp, szCCode, CELEMS(szTemp));
                }
                ...
                case PSN_APPLY: // OK button has been clicked
                    {
                        ...
                        if (nRet = RasValidateEntryName(NULL, (LPSTR)g_szEntryName))
                        {
                            switch (nRet)
                            {
                                case ERROR_ALREADY_EXISTS:
                                    ...
                                    // will be overwritten
                                    g_fValidEntry = TRUE;
                                    _snprintf(szTemp, CELEMS(szTemp), "Entry name %s already exists, will overwrite!", g_szEntryName);
                                ...
                                case ERROR_INVALID_NAME:
                                    g_fValidEntry = FALSE;
                                    _snprintf(szTemp, CELEMS(szTemp), "Entry name %s is invalid", g_szEntryName);
                                    MessageBox(hWnd, szTemp, NULL, MB_OK | MB_ICONERROR);
                                    return 0;
                                    break;
                            }
                            ...
                            // Enable the UseCountryAndAreaCodes flag
                        {
                            ...
                            if (CELEMS(szTemp) > l)
                            {
                                ...
                                lstrcpyn(szCCode, szTemp, CELEMS(szCCode));
                            }
                            else
                            {
                                return FALSE;
                        ...
                        if (CELEMS(g_lpRasEntry->szDeviceName) > l)
                        {
                            ...
                            for (i = 0; i < g_iTemp; i++)
                            {
                                ...
                                {
                                    lstrcpyn(g_lpRasEntry->szDeviceType, g_RasDevInfo[i].szDeviceType, CELEMS(g_lpRasEntry->szDeviceType));
                                }
                            }
                            ...
                            {
                                _snprintf(szTemp, CELEMS(szTemp), "RasSetEntryProperties  failed: %d", nRet);
                                MessageBox(hWnd, szTemp, NULL, MB_OK | MB_ICONERROR);
                            }
                        }    
                        else
        ...
        case WM_INITDIALOG:
            ...
            if (ERROR_BUFFER_TOO_SMALL == nRet)
            {
                ...
                if (HeapFree(GetProcessHeap(), 0, (LPVOID)lpRasEntryName))
                {
                    ...
                    if (NULL == lpRasEntryName)
                    {
                        _snprintf(szTemp, CELEMS(szTemp), "Couldn't allocate memory.");
                        MessageBox(hWnd, szTemp, NULL, MB_OK | MB_ICONERROR);
                        return FALSE;
                    }
                    ...
                    {
                        _snprintf(szTemp, CELEMS(szTemp), "RasEnumEntries  failed: %d", nRet);
                        MessageBox(hWnd, szTemp, NULL, MB_OK | MB_ICONERROR);
            ...
            switch (LOWORD(wParam))
            {
                ...
                case IDCHANGE:
                    if (g_dwEntries)
                    {
                        ...
                        {
                            _snprintf(szTemp, CELEMS(szTemp), "RasGetEntryProperty failed: %d", nRet);
                            MessageBox(hWnd, szTemp, NULL, MB_OK | MB_ICONERROR);
                        }
