...
BOOL CFileIdx::SetIndex
    ...
    ULONG       ulOffset      //@parm IN | Offset of Row in the File
    )
{
    ...
    )
{
    ...
    assert((0 <= ulDex) && (m_ulDexCnt > ulDex));
