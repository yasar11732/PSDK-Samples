...
HRESULT myDisplayRow(DBCOUNTITEM iRow, DBORDINAL cBindings, DBBINDING* rgBindings, void* pData, ULONG * rgDispSize);

HRESULT myInteractWithRowset(IRowset* pIRowset, DBCOUNTITEM* pcRows, DBCOUNTITEM cRowsObtained, BOOL fCanFetchBackwards, void* pData, DBLENGTH cbRowSize, DBBINDING* pBinding, ULONG cchBuffer, LPWSTR pwszBuffer);
