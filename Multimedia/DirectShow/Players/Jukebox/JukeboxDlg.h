...
#define STR_MEDIA_FOLDER        TEXT("\\Media\\video")
#define STR_MEDIA_FOLDER_SIZE   (sizeof(STR_MEDIA_FOLDER)/sizeof(TCHAR))
...
public:
    ...
    void DisplayECEvent(long lEventCode, LONG_PTR lParam1, LONG_PTR lParam2);
