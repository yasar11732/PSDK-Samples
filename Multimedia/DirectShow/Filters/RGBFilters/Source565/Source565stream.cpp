...
//**************************************************************************
//
CSource565BitStream::CSource565BitStream(HRESULT *phr, CSource565Bit *pParent, LPCWSTR pPinName)
     : CSourceStream(NAME("Source565Bit"),phr, pParent, pPinName)
     , CSourceSeeking( NAME("Source565Bit"), (IPin*) this, phr, &m_SeekLock )
     , m_iDelivered( 0 )
     , m_nX( 0 )
     , m_nY( 0 )
     , m_nVx( 6 )
...
//**************************************************************************
//
CSource565BitStream::~CSource565BitStream()
{
}
...
//**************************************************************************
//
STDMETHODIMP CSource565BitStream::NonDelegatingQueryInterface( REFIID riid, void ** ppv )
{
...
//**************************************************************************
//
HRESULT CSource565BitStream::ChangeRate( )
{
    return NOERROR;
}
...
//**************************************************************************
//
HRESULT CSource565BitStream::GetMediaType(int iPosition, CMediaType *pmt)
{
...
//**************************************************************************
//
HRESULT CSource565BitStream::CheckMediaType(const CMediaType *pMediaType)
{
...
//**************************************************************************
//
HRESULT CSource565BitStream::DecideBufferSize(IMemAllocator *pAlloc,
...
//**************************************************************************
//
HRESULT CSource565BitStream::OnThreadStartPlay( )
{
...
//**************************************************************************
//
HRESULT CSource565BitStream::FillBuffer(IMediaSample *pms)
{
...
//**************************************************************************
//
HRESULT CSource565BitStream::ChangeStart( )
{
    m_iDelivered = 0;
...
//**************************************************************************
//
HRESULT CSource565BitStream::ChangeStop( )
{
    return NOERROR;
}
