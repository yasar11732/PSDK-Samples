                    ...
                    switch (pnlv->hdr.code)
                    {
                        case NM_CLICK:
                            ...
                            ListView_GetItemText( m_hwndProgList,
                                                  ...
                                                  szTmp,
                                                  MAX_LEN);
                            program_number = (WORD) _ttoi(szTmp);
...
BOOL CProgramProperties::CreateAndRenderAvOutPins()
{
    ...
    hr = m_pVideoOutPin->QueryInterface(IID_IMPEG2PIDMap, (void **) &m_pIVideoPIDMap);
    ...
    hr = m_pAudioOutPin->QueryInterface(IID_IMPEG2PIDMap, (void **) &m_pIAudioPIDMap);
