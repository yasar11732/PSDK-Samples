...
const TCHAR g_achFloorFile[] = TEXT("misc\\floor.bmp");
const TCHAR g_achWallFile[]  = TEXT("misc\\env2.bmp");
    ...
    , m_pTexture( NULL )
{
    ...
    try
    {
        ...
        if( FAILED(hr))
        {
            ...
            hr = StringCchPrintf( achMsg, NUMELMS(achMsg), TEXT("Cannot find media file '%s'. ")
        ...
        /*
        CHECK_HR( 
            hr = FindMediaFile( achTexturePath, MAX_PATH, achName, NULL, NULL ),
        ...
        */
        ...
        CHECK_HR(
            hr = D3DXCreateTextureFromFileEx( pDevice, achTexturePath, 
                          D3DX_DEFAULT, D3DX_DEFAULT, D3DX_DEFAULT, 0, *g_pEnvFormat, 
