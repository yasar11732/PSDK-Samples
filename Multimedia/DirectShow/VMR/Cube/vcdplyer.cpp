...
HRESULT AddToRot(IUnknown *pUnkGraph, DWORD *pdwRegister)
{
    ...
    WCHAR wsz[256];
    (void)StringCchPrintfW(wsz, NUMELMS(wsz), L"FilterGraph %08p pid %08x\0", (DWORD_PTR)pUnkGraph, GetCurrentProcessId());
    ...
    )
{
    ...
    __try {
        ...
        {
            (void)StringCchCopyW(FileName, NUMELMS(FileName), T2W(achFileName[i]));
