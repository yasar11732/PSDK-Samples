    ...
    while ( pStartPath < pEndBuffer )
    {
        ...
        if( pStopPath > pStartPath )
        {
            if( dwRootNum < dwMaxRoots )
            {
                ...
                wcsncpy( pstrFile, URL_SCHEME, URL_SCHEME_LENGTH );
                wcsncpy( pstrFile + URL_SCHEME_LENGTH, pStartPath, dwPathNameLength );
                        ...
                        QWORD qwContext )
{
    ...
    m_dwPathNameLength = wcslen( pszContainerName );
    ...
    wcsncpy( m_pPathName, pszContainerName, m_dwPathNameLength );
    ...
    wcsncpy( m_pSearchDirName, pszNtfsPathname, sFileName );
    ...
    wcsncpy( &m_pSearchDirName[sFileName], DIR_MASK, DIR_MASK_LENGTH );
    ...
    while ( TRUE )
    {
        ...
        dwFileNameLength = wcslen( FileInfo.cFileName );
        ...
        wcsncpy( pDirInfo->m_pszwName, m_pPathName, m_dwPathNameLength );
        ...
        wcsncpy( &pDirInfo->m_pszwName[dwFileNameStartPosition], FileInfo.cFileName, dwFileNameLength );
    ...
    *pstrValue = new WCHAR[ m_dwPathNameLength + 1 ];
    ...
    if( NULL != m_pPathName )
    {
        *pstrValue[m_dwPathNameLength] = L'\0';
        ...
        wcsncpy( *pstrValue, m_pPathName, m_dwPathNameLength );
                    ...
                    )
{
    ...
    dwUrlLength = wcslen( m_pRecentChild->m_pszwName );
    ...
    wcsncpy( pInfo->pstrName, m_pRecentChild->m_pszwName, dwUrlLength );
