  ...
  switch (message) {
    ...
    * Set the clip regions of the 6 HDCs.
    ...
    case WM_SIZE: {
        ...
        SendMessage (hwndDlg, WM_PUTUPLPOINTS, (DWORD_PTR)hdcDest, (LONG_PTR)ptoDest);
        SendMessage (hwndDlg, WM_PUTUPSRCRECT, (DWORD_PTR)hdcSrc,  (LONG_PTR)ptoSrc);
        SendMessage (hwndDlg, WM_PUTUPMASKPT,  (DWORD_PTR)hdcMask, (LONG_PTR)ptoMask);
