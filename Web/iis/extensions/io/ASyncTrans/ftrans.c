...
BOOL WINAPI GetExtensionVersion(HSE_VERSION_INFO *pVer)
{
	...
	lstrcpyn((LPSTR) pVer->lpszExtensionDesc, "File Transfer using TransmitFile", HSE_MAX_EXT_DLL_NAME_LEN);
