...
BOOL SIMPLE_BROWSER::Open(P_BROWSER_CONFIG pBrowserConfig)
{
    ...
    pwszEmbeddedLinks = new WCHAR[::wcslen(m_pBrowserConfig->pwszEmbeddedLinks) + 1];
    ...
    ::wcscpy(pwszEmbeddedLinks, m_pBrowserConfig->pwszEmbeddedLinks);

    PWSTR pwszLink = ::wcstok(pwszEmbeddedLinks, L";");
    while (pwszLink != NULL)
    {
        fprintf(stdout, 
