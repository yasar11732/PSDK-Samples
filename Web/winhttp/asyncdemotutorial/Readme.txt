===============================================================================
WinHTTP - Async Demo Tutorial
===============================================================================
Last Updated: April 22, 2001

DESCRIPTION
============
This version of the AsyncDemo sample is provided as a starting point for 
the to the tutorial contained in the topic, "Developing an Asynchronous 
WinHTTP Client Application." It is purposefully incomplete. 

AsyncDemo demonstrates using Microsoft® Windows® HTTP Services (WinHTTP) 
asynchronously in a C++ client program. Its graphical interface enables the 
user to simultaneously request two network resources and watch the callback 
...
Microsoft® Win32® C/C++ application programming interface (API), as well as 
a Component Object Model (COM) Automation component suitable for use in 
...
For Windows Server2003, WinHTTP is a system side-by-side assembly. See the "Side-
