...
CFG=Render - Win32 Unicode Debug
...
!MESSAGE 
!MESSAGE NMAKE /f "Render.mak" CFG="Render - Win32 Unicode Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "Render - Win32 Debug" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "Render - Win32 Release MinSize" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "Render - Win32 Release MinDependency" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "Render - Win32 Unicode Debug" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "Render - Win32 Unicode Release MinDependency" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE "Render - Win32 Unicode Release MinSize" (based on "Win32 (x86) Dynamic-Link Library")
!MESSAGE 
...
OutDir=.\Debug
TargetPath=.\Debug\Render.dll
InputPath=.\Debug\Render.dll
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "Render - Win32 Release MinSize"
...
TargetPath=.\ReleaseMinSize\Render.dll
InputPath=.\ReleaseMinSize\Render.dll
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "Render - Win32 Release MinDependency"
...
TargetPath=.\ReleaseMinDependency\Render.dll
InputPath=.\ReleaseMinDependency\Render.dll
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "Render - Win32 Unicode Debug"

# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 1
# PROP BASE Output_Dir "Render___Win32_Unicode_Debug"
# PROP BASE Intermediate_Dir "Render___Win32_Unicode_Debug"
...
# Begin Custom Build - Registering ActiveX Control...
OutDir=.\DebugU
TargetPath=.\DebugU\Render.dll
InputPath=.\DebugU\Render.dll
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "Render - Win32 Unicode Release MinDependency"

# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 0
# PROP BASE Output_Dir "Render___Win32_Unicode_Release_MinDependency"
# PROP BASE Intermediate_Dir "Render___Win32_Unicode_Release_MinDependency"
# PROP BASE Ignore_Export_Lib 0
# PROP BASE Target_Dir ""
# PROP Use_MFC 0
# PROP Use_Debug_Libraries 0
...
TargetPath=.\ReleaseUMinDependency\Render.dll
InputPath=.\ReleaseUMinDependency\Render.dll
SOURCE="$(InputPath)"
...
!ELSEIF  "$(CFG)" == "Render - Win32 Unicode Release MinSize"

# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 0
# PROP BASE Output_Dir "Render___Win32_Unicode_Release_MinSize"
# PROP BASE Intermediate_Dir "Render___Win32_Unicode_Release_MinSize"
# PROP BASE Ignore_Export_Lib 0
# PROP BASE Target_Dir ""
# PROP Use_MFC 0
# PROP Use_Debug_Libraries 0
...
TargetPath=.\ReleaseUMinSize\Render.dll
InputPath=.\ReleaseUMinSize\Render.dll
SOURCE="$(InputPath)"
...
# Name "Render - Win32 Release MinSize"
# Name "Render - Win32 Release MinDependency"
# Name "Render - Win32 Unicode Debug"
# Name "Render - Win32 Unicode Release MinDependency"
# Name "Render - Win32 Unicode Release MinSize"
...
InputPath=.\Render.idl

BuildCmds= \
	midl /Oicf /h "Render.h" /iid "Render_i.c" "Render.idl"

".\Render.tlb" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

".\Render.h" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)

".\Render_i.c" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
   $(BuildCmds)
# End Custom Build
