...
/* at Thu Feb 24 17:37:31 2000
 */
/* Compiler settings for C:\workshop\samples\browser\EditFeatures\EdCommands.idl:
...
int __stdcall _EdCommands_IID_Lookup( const IID * pIID, int * pIndex )
{
    ...
    IID_BS_LOOKUP_INITIAL_TEST( _EdCommands, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _EdCommands, 2, *pIndex )
