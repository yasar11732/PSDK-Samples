...
// EdHost.cpp : Implementation of WinMain

// Note: Proxy/Stub Information
// To build a separate proxy/stub DLL,
// run nmake -f EdHostps.mk in the project directory.
								...
								int /*nShowCmd*/)
{
	...
	_Module.Init(ObjectMap, hInstance, &LIBID_EDHOSTLib);
	...
	while (lpszToken != NULL)
	{
		...
		{
			_Module.UpdateRegistryFromResource(IDR_EdHost, FALSE);
		...
		{
			_Module.UpdateRegistryFromResource(IDR_EdHost, TRUE);
